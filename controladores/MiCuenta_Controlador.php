...
if(isset($_POST['signupSubmit'])){
    ...
    $redirectURL = ($sessData['estado']['type'] == 'success')?'../login.php':'../Registro.php';
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				//$resetPassLink = 'https://gustavoyancha.com/ReiniciarPassword_Controlador.php?fp_code='.$uniqidStr;
				$resetPassLink = 'ReiniciarPassword_Controlador.php?fp_code='.$uniqidStr;
	...
	//store reset password estado into the session
    $_SESSION['sessData'] = $sessData;
    $redirectURL = ($sessData['estado']['type'] == 'success')?'../login.php':'ReiniciarPassword_Controlador.php?fp_code='.$fp_code;
